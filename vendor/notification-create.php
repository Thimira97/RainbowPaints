                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-row submit-btn">
                            <div class="input-data">
                                ...
                                <input type="hidden" name="table_name" value="tbl_vendor">
                    ...
                    <?php 
                        if(isset($_POST['submit'])){
                            ...
                            if($res==true){
                                ...
                                header("location:".SITEURL.'vendor/notification-all.php');
                            } else {
                                $_SESSION['noticeAdd'] = "<div class='Failed-to-do'>Failed to Added Notice.</div>";
                                header("location:".SITEURL.'vendor/notification-create.php');
                            }
                        }
                    ?>
                </div>
