	...
	<div class="header-icons">
		...
		<?php 
            if(isset($_SESSION['id'])){
                ...
                $sql = "SELECT * FROM tbl_no WHERE to_table='tbl_vendor' OR to_table='all' ORDER BY date DESC ";
                ...
                if($res==TRUE){
                    ...
                    if($count>0){
                            ...
                            ?>
                                    <div class="text">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="<?php echo SITEURL; ?>vendor/notification-reseved-single.php?id=<?php echo $id; ?>">View Notification</a></li>
                                        </ul>
                                    </div>
                                </div> 
                        ...
                        <div class="notifiBottom">
                            <a href="<?php echo SITEURL; ?>vendor/notification-reseved-all.php">View All Notifications</a>
                        </div>
                    </div>
                    <?php
                }
