        ...
        <main>
            ...
            <?php 
                if(isset($_SESSION['id'])){
                    ...
                    $sql = "SELECT * FROM tbl_no WHERE table_name='tbl_vendor' ORDER BY date DESC";
                                ...
                                ?>
                                    <div>
                                        <div class="card-head-notifi">
                                            <img src="<?php echo SITEURL; ?>images/avatar2.png" alt="img">
                                            <div>
                                        ...
                                        <div class="notifi-footer">
                                            ...
                                            <div class="notifi-links">
                                                <a href="<?php echo SITEURL; ?>vendor/notification-update.php?id=<?php echo $id; ?>" class="update">Update</a>
                                                <a href="<?php echo SITEURL; ?>vendor/notification-delete.php?id=<?php echo $id; ?>" class="delete">Delete</a>
                                            </div>
                                        </div>
                                    </div>
                                    <?php
