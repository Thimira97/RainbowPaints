...
<head>
	<meta charset="utf-8">
	<title>Rainbow Paints - Customer Login - Form</title>
        ...
        <div class="container1">
            ...
            <?php 
                if(isset($_POST['submit'])){
                    ...
                    $sql = "SELECT * FROM tbl_customershop WHERE username='$username' AND password='$password'";
                    ...
                    if($count==1){
                        if($approvement=="Yes"){
                            ...
                            header('location:'.SITEURL.'customerShop/');
                        } else {
                            $_SESSION['user'] = $username;
                            header('location:'.SITEURL.'customerShop/pending-approvement.php');
                        }
