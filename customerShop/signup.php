...
<head>
	<meta charset="utf-8">
	<title>Rainbow Paints - Customer Signup - Form</title>
...
<body>
    ...
    <div class="bodyText2">
        <div class="container2">
                <h2 class="title">Apply as a Customer</h2>
                <form action="" method="POST" enctype="multipart/form-data" class="sign-in-form">
                    ...
                    <ul>
                        <li>
                            <div class="input-field">
                                ...
                                <input type="text" name="s_name" placeholder="Enetr Company Name">	
                            </div>
                        </li>
                        <li>
                            <div class="input-field">
                    ...
                    <ul>
                        <li>
                            <div class="input-field">
                                <i class="fas fa-user"></i> 
                                <input type="text" name="owner" placeholder="Enetr Manager Name">	
                            </div>
                        </li>
                        <li>
                            <div class="input-field">
            ...
            <?php 
                if(isset($_POST['submit'])){
                    ...
                    if($res==true){
                        ...
                        header("location:".SITEURL.'customerShop/index.php');
                    } else {
                        $_SESSION['add'] = "<div class='error-text text-center'>Failed to Added Customer Shop.</div>";
                        header("location:".SITEURL.'customerShop/signup.php');
                    }
                }
