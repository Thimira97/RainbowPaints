                ...
                if($res==TRUE){
                    ...
                    if($count>0){
                            ...
                            ?>
                                    <div class="text">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="<?php echo SITEURL; ?>admin/notification-reseved-single.php?id=<?php echo $id; ?>">View Notification</a></li>
                                        </ul>
                                    </div>
                                </div> 
                        ...
                        <div class="notifiBottom">
                            <a href="<?php echo SITEURL; ?>admin/notification-reseved-all.php">View All Notifications</a>
                        </div>
                    </div>
                    <?php
                }
