                        ...
                        <div class="form-row">
                            ...
                            <div class="input-data">
                                <select name="to_table">
                                    ...
                                    <option value="tbl_customershop">To Customer Shop</option>
                                    <option value="tbl_vendor">To Vendor Company</option>
                                    <option value="tbl_employee">To Employee</option>
                                </select>
                    ...
                    <?php 
                        if(isset($_POST['submit'])){
                            ...
                            if($res==true){
                                ...
                                header("location:".SITEURL.'admin/notification-create.php');
                            }
                        }
                    ?>
                </div>
