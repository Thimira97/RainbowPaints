...
<head>
	<meta charset="utf-8">
	<title>Rainbow Paints - Admin Signup - Form</title>
    ...
    <div class="bodyText1">
        <div class="container1">
                ...
                <form action="" method="POST" enctype="multipart/form-data" class="sign-in-form">
                    ...
                    <input type="submit" name="submit" value="Sign up" class="btn1 soild">
            </form>
            ...
            <?php
                if(isset($_POST['submit'])){
                    ...
                    if($res==true){
                        ...
                        $_SESSION['add'] = "<div class='error-text text-center'>Failed to Added Admin.</div>";
                        header("location:".SITEURL.'admin/signup.php');
                    }
                }
