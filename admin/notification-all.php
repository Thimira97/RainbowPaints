        ...
        <main>
            ...
            <?php 
                if(isset($_SESSION['id'])){
                    ...
                    $sql = "SELECT * FROM tbl_no WHERE table_name='tbl_admin' ORDER BY date DESC";
                                ...
                                ?>
                                    <div>
                                        ...
                                        <div class="card-single-notifi">
                                            ...
                                            <?php 
                                                if($to_table=="tbl_vendor") {
                                                    echo "<h5 style='text-align: right;'>~ To Vendor Company ~</h5>";    
                                                } elseif($to_table=="tbl_customershop") {
                                                    echo "<h5 style='text-align: right;'>~ To Customer Shop ~</h5>";
                                                } elseif($to_table=="tbl_employee") {
                                                    echo "<h5 style='text-align: right;'>~ To Employee ~</h5>";
                                                } else {
                                                    echo "<h5 style='text-align: right;'>~ To All ~</h5>";
                                                }
                                            ?>
                                        </div>
                                        <div class="notifi-footer">
                                            ...
                                            <div class="notifi-links">
                                                <a href="<?php echo SITEURL; ?>admin/notification-update.php?id=<?php echo $id; ?>" class="update">Update</a>
                                                <a href="<?php echo SITEURL; ?>admin/notification-delete.php?id=<?php echo $id; ?>" class="delete">Delete</a>
                                            </div>
                                        </div>
                                    </div>
                                    <?php
                                            ...
                                            <div>
                                                ...
                                                <div class="notifi-footer">
                                                    <small><?php echo $date; ?></small>
                                                    <div class="notifi-links">
                                                        <small>Created by Another Admin.</small>
                                                    </div>
                                                </div>
                                            </div>
                                    <?php
