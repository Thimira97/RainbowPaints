            ...
            <?php 
                if(isset($_GET['id'])){
                    ...
                    if($count==1){
                        ...
                        $_SESSION['no-notification-found']= "<div class='error-text'>Vendoer Company Not Founded.</div>";
                        header('location:'.SITEURL.'employee/notification-reseved-all.php');
                    }
                } else {
                    header('location:'.SITEURL.'employee/notification-reseved-all.php');
                }
            ...
            <div class="notifi-single">
                <div class="notifi-info">
                    ...
                    <div class="notifi-single-footer">
                        <p><?php echo $date; ?></p>
                        <a href="<?php echo SITEURL; ?>employee/notification-create.php">Reply</a>
                    </div>
                </div>
            </div>
            </main>
