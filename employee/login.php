...
<head>
	<meta charset="utf-8">
	<title>Rainbow Paints - Employee Login - Form</title>
        ...
        <div class="container1">
            ...
            <?php 
                if(isset($_POST['submit'])){
                    ...
                    $sql = "SELECT * FROM tbl_employeee WHERE username='$username' AND password='$password'";
                    ...
                    if($count==1){
                        if($approvement=="Yes"){
                            ...
                            $_SESSION['user'] = $username;
                            header('location:'.SITEURL.'employee/pending-approvement.php');
                        }
