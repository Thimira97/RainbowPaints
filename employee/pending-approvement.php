...
<head>
	<meta charset="utf-8">
	<title>Rainbow Paints - Employee Approvement Pending</title>
...
<body>
    ...
    <div class="bodyTextpending">
        ...
        <p>Soon you will be Hired as a Customer.</p>
        <hr>
        <h6 class="check">Check Later</h6>
        <a class="logoutfornow" href="../employees.php">Logout For Now</a>
    </div>
